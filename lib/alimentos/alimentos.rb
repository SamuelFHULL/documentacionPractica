...
#			kcal = kcal + alimento.valorEnergetico*lista_cantidades[cont]
#			gei = gei + alimento.gei*lista_cantidades[cont] #Incrementar GEI de cada alimento
#			terreno = terreno + alimento.terreno*lista_cantidades[cont] #Incrementar terreno de cada alimento
